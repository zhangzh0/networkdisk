...
public class DaoSupport {
	...
	/**
	 * 执行一条select语句，返回一个对象的list。 查询的结果中将不包含exceptColumns中声明的字段
	 * 
	 * @param <T>
	 * @param exceptColumns
	 * @param whereSql
	...
	/**
	 * 执行一条select语句，返回一个对象的list。 查询的结果中将包含columns中声明的字段
	 * 
	 * @param <T>
	 * @param columns
	 * @param whereSql
	 ...
	 * @return
	 */
	public static <T> Object queryOntExcept(Class<T> beanClass, String exceptColumns[], Object param[],
			String whereSql) {
		initConn();
		Object result = null;
		String sql = VirtualORM.selectExcept(beanClass, exceptColumns, whereSql);
