...
public class RegisterTransaction {
	...
	public static User register(User user, long initSize) {
		...
		Object param0[] = { user.getEmail(), user.getUsername(), user.getPassword(), user.getJoindate(),
				user.getGender() };
		...
		try {
			...
			Object obj1 = runner.query(conn, "select LAST_INSERT_ID()", new ScalarHandler<Object>());
			homeID = Long.valueOf(obj1.toString());
			String path = "/" + homeID + "/";
			Object param3[][] = { { uID, homeID, "我的文档", path }, { uID, homeID, "我的音乐", path },
					{ uID, homeID, "我的相册", path }, { uID, homeID, "我的图书", path } };
