...
public class UploadTransaction {
	...
	public static MyFile upload(MyFile myFile) {
		...
		Object param0[] = { myFile.getUser_id(), myFile.getParent_id(), myFile.getName(), myFile.getPath(),
				myFile.getLocation(), myFile.getDescription(), myFile.getSize(), myFile.getMd5(), myFile.getType() };
		...
		try {
			...
			file_id = Long.valueOf(obj.toString());
