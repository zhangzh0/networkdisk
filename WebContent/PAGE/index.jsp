...
<html>
	...
	<body>
		<div id="wrap">
    		<div id="sky">
    			<a id="logo" href="/home/disk" title="zhangzh"><img src="/resource/img/logo.png"/></a>
			</div>
	        <div id="main">
	        	<div id="vip">
	        		<div id="example">
		        		<!-- <img src="/resource/img/me.png"/> -->
		        		<iframe frameborder="0" scrolling="no" src="PAGE/clock.html" width="532px" height="504px"></iframe>
		        	</div>
